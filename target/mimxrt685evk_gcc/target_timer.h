 ...
 * タイマ割込みハンドラ登録のための定数
 */
#define INTNO_TIMER  (IMXRT600_CTIMER0_IRQn + 16) /* 割込み番号 */
...
{
    return sil_rew_mem(IMXRT600_CTIMER_TC(IMXRT600_CTIMER0_BASE));
}
...
Inline void target_hrt_set_event(HRTCNT hrtcnt)
{
    ...
    sil_wrw_mem(IMXRT600_CTIMER_MR0(IMXRT600_CTIMER0_BASE), current + hrtcnt);
    sil_wrw_mem(IMXRT600_CTIMER_MCR(IMXRT600_CTIMER0_BASE), IMXRT600_CTIMER_MCR_MR0I);
