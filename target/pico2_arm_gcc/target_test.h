...
/*
 * テストプログラムのターゲット依存定義（RaspberryPi Pico2用）
 */
...
/*
 *  int1テスト用割込み定義
 *  TIMER0 ALARM1 (IRQ1+16=17) を使用（カーネルタイマALARM0とは別）
 */
#define INTNO1			(RP2350_TIMER0_1_IRQn + 16)	/* 17 */
#define INTNO1_INTATR	TA_ENAINT
#define INTNO1_INTPRI	(-2)

/*
 *  INTNO1割込みフラグのクリア（TIMER0 ALARM1のINTRレジスタbit1をクリア）
 */
