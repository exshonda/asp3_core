...
/*
 *  システムサービスのターゲット依存部（ARM MPS3-AN547 用）
 */
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME "ARM MPS3-AN547"
 ...
 */
#define SIO_UART_BASE		MPS3_AN547_UART0_BASE	/* UARTのベース番地 */
 ...
 */
#define INTNO_SIO		(MPS3_AN547_UART0_COMBINED_IRQn + 16)
												/* UART割込み番号 */
