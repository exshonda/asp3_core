# Target (Zybo Z7) awareness helpers for gdb OS-awareness (ASP3).
#
# 役割: ターゲット（ボード）依存の知識。本ボードはチップ(Zynq-7000)の機能をそのまま使い，
#       現時点でボード固有の追加項目は無いため，chip_os_awareness の API を再エクスポートする。
#
# chip_os_awareness.py は arch/arm_gcc/zynq7000 にあるため，本ファイルからの相対パスで
...
sys.path.insert(0, os.path.normpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../arch/arm_gcc/zynq7000")))
