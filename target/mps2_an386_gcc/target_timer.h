...
/*
 *  プロセッサクロックの 1us あたりのカウント数（QEMU AN386 は 25MHz）
 */
 ...
 *  割込みタイミングに指定する最大値（us）
 *
 *  24bit / 25MHz ＝ 約 0.67 秒．これより先のイベントはカーネルが分割する．
 */
