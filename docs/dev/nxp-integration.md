...
- **ボードプロジェクト** `evkmimxrt685/`：SDK examples のボードファイル
...
| testexec 代表8件（task1/sem1/flg1/dtq1/int1/tmevt1/hrt1/dlynse） | **全PASS**（hrt1=完走マーカ・dlynse NG=0＝較正値27/19有効） |
...
- testexec 全件ランナ（stm32 の `testexec_stm32.py` 相当の外側リポジトリ用ラッパ）
