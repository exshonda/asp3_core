...
| TTSP3 適合性テスト | `ttsp3-conformance.md` | 実施中（zybo_z7-qemu：ドライバ`test/ttsp/run_ttsp.py`＋静的API自動判定＋ttg連携 完了・staticAPI 138/138＋functional 全1813/1813 PASS。横断/CIは後続） |
