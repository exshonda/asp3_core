...
| FSP統合 | `fsp-integration.md` | 実施中（asp3_core側＝PORTING_GUIDE注記＋CMSIS協調のCPACR/FPCCR修正(473d97e)。SDK側＝asp3_fsp submodule化・EK-RA6M5 を RASC6.2.0+ATfE clang でビルド検証完了。EK-RA8M2実ビルド・実機は後続） |
