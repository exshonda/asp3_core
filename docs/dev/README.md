...
| STM32 HAL統合 | `stm32-integration.md` | 実施中（NUCLEO-H563ZI/STM32H563・Cortex-M33。A案submodule化＋非TECS+Python cfg化でビルド成功＝H563ZI.elf／FW_H5 V1.6.0 headless生成。実機検証が次ステップ） |
