...
**残り計画**：
- Phase2：03_quickstart.md ～ 08_system_services.md（user.txt §3-8）
- Phase3：09_support_libraries.md ～ 13_reference_detail.md、及び configurator.txt等

**Git情報**：ベース（本セッション開始時）= e12e68d。
リスト再現: `git diff --stat HEAD -- docs/spec/`（コミット後）
