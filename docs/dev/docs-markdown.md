...
**残り計画**：
- Phase3：09_support_libraries.md ～ 13_reference_detail.md（user.txt §9-13、
  §9=1730-1823行・§10=1824-2371行・§11=2372-2714行・§12=2715-2821行・§13=2822-3017行）、
  及び configurator.txt・design系等

**Git情報**：ベース（本セッション開始時）= e12e68d。Phase1コミット= dc15adb。
リスト再現: `git diff --stat HEAD -- docs/spec/ scripts/`（コミット後）

### 残り手順（未着手）

- 手順2 Phase2-3：docs/spec/ user.txt 残り章 + 他仕様文書
- 手順3：simtimer.txt の削除
- 手順4：参照の張り替え（doc/*.txt → docs/spec/）
- 手順5：記録（最終）
