...
（注：2026-06-16 に QEMU M33 ターゲットを mps2-an505/IoTKit へ置換〔現ターゲット名 mps2_an505_gcc〕。下記の `target/mps2_an521_gcc/target.cmake` は確認当時のパス記録。現行は `target/mps2_an505_gcc/target.cmake`。）
