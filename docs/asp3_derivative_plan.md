...
| [asp3_stm32cubemx](https://github.com/exshonda/asp3_stm32cubemx) | STM32 + CubeMX HAL |
...
### 取得機構
`asp3_pico`・`asp3_fsp`・`asp3_stm32cubemx` がカーネルをどう参照するかの統一。  
...
- [asp3_stm32cubemx](https://github.com/exshonda/asp3_stm32cubemx)
