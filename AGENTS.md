...
| [asp3_mcuxsdk](https://github.com/exshonda/asp3_mcuxsdk) | NXP MCUXpresso SDK統合（i.MX RT685）。**Phase A完了（ベアメタル `mimxrt685evk` は asp3_core 本体に追加済）**・Phase B=SDK統合は準備中（`docs/dev/nxp-integration.md`） | （実機検証待ち・EVK-MIMXRT685保有） |
